# 1. Escreva um programa que leia 10 valores inteiros e armazene em uma lista. O programa 
# deve imprimir no terminal quantos valores pares foram digitados pelo usuário.
# Dica: use o operador “%” para verificar se o número é par (ZERO é neutro, ZERO NÃO É PAR). 
# Exemplos:


# 2. Escreva um programa que recebe como entrada valores inteiros para criar duas listas
# de mesmo tamanho. O tamanho das listas deverá ser definido pelo usuário. O programa 
# deverá somar os valores pares e ímpar de cada uma das listas. Em seguida,
...
# da lista por caracteres correspondentes da string nos mesmos índices. Exiba a 
# sequência resultante, separada por um espaço em branco. 
# Exemplo:
...
# 8. Escreva um programa que receba como entrada uma string constituída por uma sequência 
# de números inteiros separados por espaço. O programa deverá transformar essa string em uma 
# lista de números inteiros e apresentar o resultado da soma dos valores das posições ímpares dessa lista. 
# Exemplos:
...
#cada palavra no texto repassado como entrada para o programa. Os sinais de 
# pontuação não devem ser contabilizados, como por exemplo “.” Ou “,”. 
# Exemplo:


# 10. Escreva um programa que leia 9 valores inteiros e armazene em uma matriz 3x3. O
# programa deve informar quantos valores ímpares foram digitados pelo usuário e imprimir 
# a matriz no formato 3x3. Dica: use o operador “%” para verificar se o número é ímpar. “,”. 
# Exemplo:
...
# valores inteiros correspondente ao tamanho necessário para preencher todas as posições 
# da matriz. O programa deverá exibir a matriz de dimensões “m por n” informar o
...
# 13. Escreva um programa que armazene valores inteiros em duas matrizes A e B de tamanho 
# 3x3. Em seguida gere uma terceira matriz C 3x3 formada pelos maiores valores
...
# 4x4. Em seguida exiba a soma dos elementos que estão em índices de linha ímpar e coluna par. 
# Exemplo:
...
# seguintes passos: solicite ao usuário as dimensões da matriz; apresente a matriz gerada 
# de forma aleatória; informe o valor e posição do maior e menor valor na matriz.
# Exemplos:


# 16. Escreva um programa que realiza o produto matricial entre duas matrizes de dimensões 
# 3x3. Os valores das duas matrizes devem ser gerados de forma aleatória com
...
# 17. Escreva um programa que realiza o produto matricial entre duas matrizes de dimensões 
# ‘j’ por ‘k’ e ‘m’ por ‘n’ fornecidas pelo usuário. Os valores das duas matrizes devem
...
# realizar o produto matricial, informe a impossibilidade ao usuário e as duas matrizes geradas. 
# Exemplos:
